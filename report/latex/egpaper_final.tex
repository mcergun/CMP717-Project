...
Table \ref{tab:sigma-est} shows results for this experiment. The results look promising for both methods. The problem with this experiment is that they might not hold true for actual sensor noise.
\begin{table}[h!]
	\centering
	\label{tab:sigma-est}
	\begin{tabular}{cccc}
