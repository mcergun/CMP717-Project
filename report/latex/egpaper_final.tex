...
As a final note, we have seen that the filter is capable when correct parameters are fed. But finding those parameters for each case can be a problem for a general use filter.
