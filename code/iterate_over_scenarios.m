...
input_est_vals_m1 = zeros(scenario_end, scene_end, lambda_end, mu_end, nu_end);
input_est_vals_m2 = zeros(scenario_end, scene_end, lambda_end, mu_end, nu_end);
output_est_vals_m1 = zeros(scenario_end, scene_end, lambda_end, mu_end, nu_end);
output_est_vals_m2 = zeros(scenario_end, scene_end, lambda_end, mu_end, nu_end);
